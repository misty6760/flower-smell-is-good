scoreboard objectives add LobbyLanternParticle dummy
scoreboard players set @p LobbyLanternParticle 0
function comma6760:lobby/lobby_lantern_click/lantern_flame
scoreboard objectives add LobbyAirParticle dummy
scoreboard players set @p LobbyAirParticle 0
function comma6760:lobby/lobby_default_air_particle
scoreboard objectives add LobbyCandleClick dummy
...
scoreboard objectives add DatapackCreatorHitCount dummy
